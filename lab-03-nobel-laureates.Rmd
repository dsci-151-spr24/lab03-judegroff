...
There does seem to be more US Nobel laureates than other countries.   
...
ggplot(nobel_living_science, aes(y = country_us, fill = born_country_us)) +
  geom_bar() +
  facet_wrap(~ category) +
  labs(title = "What Nobel laureates won in the US, and were also born there?",
       x = "Count",
       y = "Country",
       fill = "Born in US")
...
The Buzzfeed plots and my plots do appear to have very similar results.
...
The laureates are most commonly from Germany, with Japan being a close second.
